...
@section('content')
    ...
    <section class="mt-[4.5rem] max-xl:mt-[3rem]  h-[250px] w-full  relative z-50 bg-[#8DD7FA] shadow-sm">
        <div
            ...
            <div class="w-[60%] max-sm:w-full flex flex-col gap-6 px-8 items-start justify-center  z-20">
                ...
                <div class="max-h-[200px] max-sm:h-[150px] overflow-y-auto">
                    <p class="text-[#686868] group-hover:text-white font-[300] text-start text-lg max-sm:text-[1rem]">
                        {{ $post->description }}</p>
                </div>
            </div>
            <div class="flex justify-end w-[50%] h-full max-sm:w-full right-0  absolute z-10 items-end max-sm:opacity-30">
                <img src="{{ url($post->thumbnail_link) }}" alt=""
                    class="w-full h-full rounded-r-xl object-cover shadow-md"
    ...
    <section class="flex flex-col justify-center gap-4 py-10  bg-white mt-[14rem] mb-12 max-xl:mt-[8rem] max-sm:mt-[5rem]">
        <div class="w-4/5 mx-auto flex flex-col justify-center gap-12  items-center">
            <div class="flex max-xl:flex-col gap-y-8 justify-between items-center">
                <div class="w-full flex flex-col gap-y-6 justify-between max-xl:mt-6 px-4 max-xl:order-2"
                    ...
                    <div class="flex justify-start gap-4">
                        ...
                        <div class="flex max-xs:flex-col gap-2">
                            ...
                            <a href="{{ $post->iframe }}" target="_blank" rel="noopener noreferrer"
                                class="text-[#23404A] text-[1rem]">{{ $post->iframe }}</a>
                        </div>
                    </div>
                </div>
