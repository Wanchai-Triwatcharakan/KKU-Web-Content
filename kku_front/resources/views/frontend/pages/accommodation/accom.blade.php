            ...
            <div class="swiper-wrapper ">
                @foreach ($hotels as $hotel)
                    <div class="swiper-slide max-lg:!flex max-lg:items-center max-lg:flex-col gap-y-6 max-lg:relative max-lg:py-10  w-full sm:overflow-auto"
                        ...
                        <!-- Image Slider -->
                        <div
                            class="max-lg:order-1 w-[650px] h-[450px] max-uu:w-[550px]  max-uu:h-auto lg:absolute rounded-lg shadow-lg left-[20rem] top-[15rem] max-uu:left-[15rem] max-uu:top-[12rem] max-yy:left-[5rem] max-yi:left-0  max-yy:top-[6rem] max-xl:left-0 max-xl:w-[450px]  max-xl:h-[350px] max-sm:max-w-[350px]  max-sm:max-h-[350px]">
