...
@section('content')
    ...
    <section class="w-4/5 mt-[5rem] max-xl:mt-[4rem] mx-auto py-10 flex flex-col gap-4">
        <div class="w-[1080px] h-[500px] max-xl:w-full max-xl:max-h-[300px] mx-auto rounded-xl" data-aos="zoom-in" data-aos-duration="3000">
        ...
        <div class="mt-12 flex flex-col">
            <p class="text-[#23404A] font-bold text-center text-3xl max-md:text-xl max-sm:text-lg z-40 max-md:px-2"
                data-aos="zoom-in" data-aos-duration="3000">Lorem ipsum dolor sit
            </p>
            <p class="text-[#75868B] font-light text-center text-2xl max-2xl:text-xl max-lg:text-lg max-sm:text-[1rem] pt-2 z-40"
                data-aos="zoom-in" data-aos-duration="3000">Lorem ipsum dolor sit amet consectetur. Blandit sed tincidunt
                sit purus lacus consectetur nulla montes.</p>
        </div>

        <div class="flex justify-end gap-4 text-[#75868B] items-center my-4 max-xl:justify-center" data-aos="flip-down" data-aos-duration="3000">
        ...
        <div class="flex justify-between items-center mt-16">
            <a href=""
                class="bg-[#BCEB77] flex gap-4 items-center justify-center p-2 rounded-md w-[120px] font-medium text-[#27363C] text-[1rem] hover:bg-[#E7E7E7] group"data-aos="fade-left" data-aos-duration="3000">
                <div class="w-6 h-6">
            ...
            <a href=""
                class="bg-[#BCEB77] flex gap-4 items-center justify-center p-2 rounded-md font-medium w-[120px] text-[#27363C] text-[1rem] hover:bg-[#E7E7E7] group" data-aos="fade-right"  data-aos-duration="3000">
                ถัดไป
                <div class="w-6 h-6">
                    <svg fill="currentColor" class="flex-shrink-0 w-full h-full text-[#23404A] transition duration-75"
                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
