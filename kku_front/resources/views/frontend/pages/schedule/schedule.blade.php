...
@section('content')
    ...
    <section class="flex flex-col gap-4 relative  pt-10 bg-white ">
        ...
        @for ($i = 0; $i < 2; $i++)
            <div class="flex flex-col w-[70%] max-md:w-full mx-auto border border-[#F7FAF3] bg-[#F7FAF3] my-12 items-center z-50 rounded-xl shadow-md" data-aos="fade-left" data-aos-duration="3000">
                <div class="flex max-xl:flex-col gap-6 justify-between p-4 rounded-xl ">
                    <div class="w-[450px] h-[300px] rounded-md">
                        <img src="/images/home/111.png" alt="" class="w-full h-full rounded-xl">
                    </div>

                    <div class="w-full flex flex-col justify-between py-4 gap-y-6 max-xl:mt-6 px-4">
                        <div class="flex flex-col gap-y-6">
                            <p class="text-[#2F99C7] font-bold text-3xl max-md:text-xl">วันที่ 13 พฤษาจิกายน 2567</p>
            ...
            <div class="flex flex-col w-[70%] max-md:w-full mx-auto border border-[#F7FAF3] bg-[#F7FAF3]  my-12 items-center z-50 rounded-xl shadow-md" data-aos="fade-right" data-aos-duration="3000">
                <div class="flex max-xl:flex-col gap-6 justify-between p-4 rounded-xl ">
                    <div class="w-full flex flex-col justify-between  gap-y-6 max-xl:mt-6 px-4">
                        <div class="flex flex-col gap-y-6">
                            <p class="text-[#2F99C7] font-bold text-3xl max-md:text-xl">วันที่ 14 พฤษาจิกายน 2567</p>
                            <div class="border-2 border-[#2F99C7] rounded-full "></div>
                            <p class="text-[#75868B] text-xl max-md:text-lg">Training Workshop
                                “การสร้างนวัตกรรมและเส้นทางสู่
                                Medical Device & Wellness Tech Business” (จัดร่วมกับ NIA)</p>
                    ...
                    <div class="w-[450px] h-[300px] rounded-md shadow-md">
                        <img src="/images/home/111.png" alt="" class="w-full h-full rounded-xl">
                    </div>
                </div>
            </div>
