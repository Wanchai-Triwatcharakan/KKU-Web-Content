...
const ResetPasswordPage = () => {
  ...
  return (
    <form id="forgetpassword-page" className="guest-form">
      ...
      <h1 className="login-title">รีเซ็ตรหัสผ่านของคุณ</h1>
      ...
      <button type="button" className="btn-signin" onClick={resetPasswordHandler} disabled={isFetching}>{t("รีเซ็ต")}</button>
