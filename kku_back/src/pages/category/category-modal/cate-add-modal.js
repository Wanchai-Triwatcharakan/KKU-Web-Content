            ...
            <div style={{width: "100%"}} className="form-details">
              ...
              <div className="setting-controls">
                <div className="switch-form">
                  <FormGroup>
                    <FormControlLabel  control={<Switch onChange={(e) => setAddData({...addData, is_menu: e.target.checked})} checked={addData.is_menu} />} label="แสดงบนแถบแมนู (Header)" labelPlacement="start" />
                  </FormGroup>
                </div>
                <div className="switch-form">
                  <FormGroup>
                    <FormControlLabel  control={<Switch onChange={(e) => setAddData({...addData, is_bottomside: e.target.checked})} checked={addData.is_bottomside} />} label="แสดงบนแถบแมนู (Footer)" labelPlacement="start" />
                  </FormGroup>
                </div>
                <div className="switch-form">
                  <FormGroup>
                    <FormControlLabel  control={<Switch onChange={(e) => setAddData({...addData, is_main_page: e.target.checked})} />}  label="แสดงบนเว็บไซต์" labelPlacement="start" />
                  </FormGroup>
                </div>
