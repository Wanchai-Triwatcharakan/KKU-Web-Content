...
const ModalEditProduct = (props) => {
  ...
  const saveModalHandler = (e) => {
    ...
    formData.append("tel", editData.tel);
    formData.append("line_id", editData.line_id);
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterMoment}>
      <Modal
        ...
        aria-describedby="modal-edit-product"
      >
        <Box className="modal-custom">
          <div className="modal-header">
            <h2>
              <FontAwesomeIcon icon={faEdit} />
              <span>{t("แก้ไขสินค้า")}</span>
            </h2>
            <IconButton
            ...
            <fieldset className="modal-fieldset">
              ...
              <div className="form-details">
                ...
                <div style={{ marginTop: "1rem" }} className="ck-content">
                  {/* <label className="ck-edit-product">Content</label> */}
                  {ckValue !== null && (
                    <CKeditorComponent
                      ckNameId="ck-edit-product"
                      value={ckValue}
                      onUpdate={setCkValue}
                    />
                  )}
