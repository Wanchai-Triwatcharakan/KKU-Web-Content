...
const ModalAddProduct = (props) => {
  ...
  const saveModalHandler = () => {
    ...
    formData.append("tel", addData.tel);
    formData.append("line_id", addData.line_id);
          ...
          <div className="modal-body overflow-scroll-custom">
            <fieldset className="modal-fieldset">
              ...
              <div className={`box-radio-container cate-menu-list`}>
                <div
                  style={{
                    border: addDataValid.category ? "1px solid red" : "none",
                  }}
                  className="brc-body overflow-scroll-custom"
                >
                  <FormControl className="brc-form-control">
                    <FormLabel id="box-radio">ประเภทสินค้า</FormLabel>
                    <RadioGroup
              ...
              <div className="form-details">
                ...
                <h3 className="product-detail-title">{t("รายละเอียด")}</h3>
                <TextField
                  onChange={(e) =>
                    setAddData((prevState) => {
                ...
                <div style={{ marginTop: "1rem" }} className="ck-content">
                  {/* <label className="ck-add-product">Content</label> */}
                  <CKeditorComponent
                    ckNameId="ck-add-product"
                    value={ckValue}
                    onUpdate={setCkValue}
                  />
                </div>
                ...
                <h3 className="product-detail-title">{t("การแสดงผล")}</h3>
