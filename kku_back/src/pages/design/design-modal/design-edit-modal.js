...
const ModalEditDesign = (props) => {
  ...
  const [ckValueFront, setCkValueFront] = useState(null);
  const [ckValueDetail, setCkValueDetail] = useState(null);
  const [ckValuePromotion, setCkValuePromotion] = useState(null);
  ...
  useEffect(() => {
    if (items !== null) {
      ...
      /* Set CkValue */
      setCkValueFront(newData.content_front);
      setCkValueDetail(newData.content_detail);
      setCkValuePromotion(newData.content_promotion);
  ...
  const saveModalHandler = (e) => {
    ...
    formData.append("content_front", ckValueFront ? ckValueFront : "");
    formData.append("content_detail", ckValueDetail ? ckValueDetail : "");
    formData.append(
      "content_promotion",
      ckValuePromotion ? ckValuePromotion : ""
    );
              ...
              <div style={{ width: "100%" }} className="form-details">
                ...
                {editData.pin && (
                  <div style={{ marginTop: "1rem" }} className="ck-content">
                    <label className="ck-edit-design">
                ...
                <div style={{ marginTop: "1rem" }} className="ck-content">
                  <label className="ck-edit-design">รายละเอียดของบ้าน</label>
                  {ckValueDetail !== null && (
                    <CKeditorComponent
                      ckNameId="ck-edit-design"
                      value={ckValueDetail}
                ...
                <div style={{ marginTop: "1rem" }} className="ck-content">
                  <label className="ck-edit-design">โปรโมชัน</label>
                  {ckValuePromotion !== null && (
                    <CKeditorComponent
                      ckNameId="ck-edit-design"
