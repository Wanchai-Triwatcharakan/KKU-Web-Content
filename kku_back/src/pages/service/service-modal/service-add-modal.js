...
import { svCreateService } from "../../../services/service.service";
...
const ModalAddService = (props) => {
  ...
  const { isOpen, menuList, servicesList, category, totalData } = props;
  ...
  const saveModalHandler = () => {
    ...
    if (addData.title === "" || addData.description === "" || addData.address === "" || addData.size === "" || addData.status === "" || radioResult === null || isFetching) {
      return false;
    }
    ...
    /* Fetch Data */
    svCreateService(formData).then((res) => {
      setIsFetching(false);
      if (res.status) {
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterMoment}>
      <Modal
        ...
        aria-describedby="modal-add-service"
      >
        <Box className="modal-custom">
          <div className="modal-header">
            <h2>
              <FontAwesomeIcon icon={faAdd} />
              <span>{t("เพิ่มบริการ")}</span>
            </h2>
            <IconButton
          ...
          <div className="modal-body overflow-scroll-custom">
            <fieldset className="modal-fieldset">
              ...
              <div className={`box-radio-container cate-menu-list`}>
                <div style={{ border: addDataValid.category ? '1px solid red' : 'none' }} className="brc-body overflow-scroll-custom">
                  <FormControl className="brc-form-control">
                    <FormLabel id="box-radio">ประเภทบริการ</FormLabel>
                    <RadioGroup
                      aria-labelledby="box-radio"
                      name="controlled-radio-buttons-group"
                      onChange={(e) => setRadioResult(e.target.value)}
                    >
              ...
              <div className="form-details">
                ...
                <FieldsetUI
                  ...
                  label={t("รูปภาพเพิ่มเติม (ขนาดไม่เกิน 1300x1300 pixels)")}
                >
                ...
                <div style={{ marginTop: "1rem" }} className="ck-content">
                  {/* <label className="ck-add-service">Content</label> */}
                  <CKeditorComponent
                    ckNameId="ck-add-service"
                    value={ckValue}
                    onUpdate={setCkValue}
                  />
                </div>
